...
const Map2D = dynamic(() => import("@/components/Map2D"), {
  ssr: false,
  loading: () => (
    <div className="w-full h-full min-h-[360px] sm:min-h-[440px] flex flex-col items-center justify-center bg-[#87CEEB] text-[#1e293b] font-mono text-xs gap-3">
...
export default function ShippingAustralia() {
  ...
  return (
    <section
      id="shipping"
      className="relative z-20 py-10 sm:py-12 md:py-16 px-4 sm:px-6 md:px-12 lg:px-16 bg-white text-[#241919] border-t border-[#747474]/15 overflow-hidden"
    >
      <div className="max-w-7xl mx-auto relative z-10 space-y-8 md:space-y-12">
          ...
          <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-6">
            <div className="max-w-3xl space-y-3">
              <h2 className="font-display font-light leading-[1.05] tracking-tight mb-4">
                <span className="text-[#241919] block text-3xl sm:text-5xl md:text-6xl lg:text-[64px] mb-2">
                  Seamless Ocean Freight
                </span>
                <span className="text-[#c85a32] block text-2xl sm:text-4xl md:text-5xl italic">
                  Chennai to 40+ World Ports
                </span>
              </h2>

              <p className="text-[13.5px] sm:text-[15.5px] text-[#747474] font-light leading-relaxed max-w-2xl">
            ...
            <div className="flex items-center gap-3 flex-none">
              <motion.button
                ...
                className="group inline-flex items-center gap-2.5 px-6 sm:px-7 py-3 sm:py-3.5 text-xs font-mono uppercase tracking-wider font-bold bg-transparent border border-[#241919] text-[#241919] hover:bg-[#241919] hover:text-[#f1f5f9] transition-all duration-300 cursor-pointer rounded-xl"
              >
        ...
        {/* ══════════════════════════════════════════════════════════════
            INTERACTIVE SEA SHIPMENT MAP & CALCULATOR
        ══════════════════════════════════════════════════════════════ */}
        <div className="bg-white rounded-2xl border border-gray-200 shadow-xl overflow-hidden flex flex-col">
          {/* Top Header */}
          <div className="px-4 sm:px-6 py-3.5 bg-white border-b border-gray-200 shrink-0">
          ...
          {/* Main Body */}
          <div className="flex flex-col lg:flex-row min-h-[540px] lg:h-[680px]">
            {/* 2D Map Panel */}
            <div
              className="w-full lg:w-[76%] xl:w-[78%] h-[320px] sm:h-[400px] md:h-[480px] lg:h-full relative flex-none lg:flex-1"
            ...
            {/* Calculator Panel */}
            <div className="w-full lg:w-[24%] xl:w-[22%] min-w-0 lg:min-w-[320px] h-auto min-h-[480px] lg:h-full z-20 border-t lg:border-t-0 lg:border-l border-gray-200 shadow-2xl relative bg-white">
              <CalculatorPanel
                origin={origin}
                setOrigin={setOrigin}
                destination={destination}
