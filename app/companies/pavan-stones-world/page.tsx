...
import { PAVAN_STONES_WORLD_EDITORIAL_DATA } from "@/lib/companyEditorialData";
...
const COMPANIES_DATABASE: Record<string, CompanyData> = {
  "pavan-impex": {
    ...
    applications: [
      ...
      },
      {
        ...
        desc: "Adds organic warmth and earthy charm to hospitality developments.",
      },
    ],
    packaging: {
      crateType: "ISPM-15 Certified Heavy-Duty Hardwood Crates with Steel Strapping",
      safetyFeatures: ["Internal waterproof plastic lining", "High-density polystyrene corner buffers", "Reinforced bottom skids"],
      capacity: "20-Foot FCL Container (Approx. 750 to 900 sqm of 15mm slate)",
      avgWeightPerSqm20mm: 42, // 42 kg per sqm for 15mm avg
    },
  },
  ...
  "sai-balaji-impex": {
    ...
    tagline: "Dense Calcareous Limestones & Precision Anti-Skid Pavers",
    divisionName: "Calcareous Limestone & Paving Division",
    speciality: "Limestone Pavers, Pool Copings & Stepping Stones",
    established: "1998",
    location: "Cuddapah & Kurnool Limestone Basins, Andhra Pradesh, India",
    coordinates: "14.4673° N · 78.8242° E · CUDDAPAH",
    accentColor: "#3d2b18",
    overview: [
      "Limestone is known for its durability, natural beauty, and non-slip properties. It stays cool underfoot in hot weather, making it the preferred choice for outdoor areas, swimming pools, and patios."
    ],
    geologyStory: {
      title: "The Ancient Cuddapah Basin Formations",
      description:
        "Deposited over 1.4 billion years ago in an epicontinental marine basin, Cuddapah limestone consists of ultra-fine calcilutites and dolomitic limestones. Millions of years of lithostatic compression produced a micro-crystalline matrix with exceptional flexural strength and natural chemical resilience.",
      points: [
        "Calcrete mineral density eliminates chalkiness and flaking common in younger limestones.",
        "Thermal conductivity engineered by nature — remains remarkably cool under harsh direct sun.",
        "Exceptional natural R11 anti-skid surface profile without chemical etching.",
        "Zero salt efflorescence and impervious to pool chlorine degradation.",
      ],
    },
    finishesGuide: [
      {
        name: "Natural Non-Slip",
        texture: "Natural fine-grained textured surface with uniform slip resistance",
        reflectivity: "Non-Reflective Natural",
        slipRating: "R11 (Certified Safe Wet Grip)",
        bestFor: "Swimming Pool Coping, Alfresco Decks & Patios",
        icon: "✦",
      },
      {
        name: "Calibrated & Sawn",
        texture: "Precision diamond-sawn bottom and sides for millimeter joint tolerance",
        reflectivity: "Uniform Sawn",
        slipRating: "N/A (Bonding Base)",
        bestFor: "Rapid adhesive paving with neat 3mm joint lines",
        icon: "◈",
      },
      {
        name: "Tumbled Antique",
        texture: "Distressed soft edges and smooth velvet surface profile",
        reflectivity: "Antiqued Velvet",
        slipRating: "R11 (Comfort Texture)",
        bestFor: "Heritage Courtyards, Verandas & Rustic Walkways",
        icon: "◎",
      },
      {
        name: "Cobbled / Hand-Dressed",
        texture: "Hand-chipped chiseled sides creating historic cobblestone appearance",
        reflectivity: "Matte Chiseled",
        slipRating: "R12 (Extreme Traction)",
        bestFor: "Vehicular Driveways, Ramps & Garden Pathways",
        icon: "⬡",
      },
    ],
    products: [
      {
        ...
        colors: ["Deep Dark Grey to Rich Black"],
        description: "Extremely tough, non-porous. Perfect for outdoor paving, driveways, garden paths. Doesn't get slippery when wet.",
        finishes: ["Natural Non-Slip", "Tumbled Antique", "Calibrated Sawn"],
        gradient: "linear-gradient(135deg, #242528 0%, #35373d 50%, #1a1b1d 100%)",
        recommendedUse: "Extremely tough, non-porous. Perfect for outdoor paving, driveways, garden paths. Doesn't get slippery when wet.",
      ...
      },
      {
        ...
        colors: ["Warm Yellow", "Beige", "Golden Cream Tones"],
        description: "Brings warmth and brightness. Popular for patios, walkways, courtyard flooring.",
        finishes: ["Antiqued Velvet", "Natural Riven", "Calibrated"],
        gradient: "linear-gradient(135deg, #7c6435 0%, #a4884c 50%, #524223 100%)",
        recommendedUse: "Brings warmth and brightness. Popular for patios, walkways, courtyard flooring.",
        slipRating: "R11 Anti-Skid",
        heatResistance: "High Solar Reflectance",
      },
      {
        id: "lime-blue-limestone",
        name: "Lime Blue Limestone",
        colors: ["Subtle Blue-Grey", "Steel Blue"],
        description: "Modern, sophisticated color. Excellent for poolside coping, modern landscapes, terrace paving.",
        finishes: ["Flamed Sawn", "Bullnosed Coping", "Brushed Antique"],
        gradient: "linear-gradient(135deg, #37434f 0%, #536475 50%, #252e37 100%)",
        recommendedUse: "Modern, sophisticated color. Excellent for poolside coping, modern landscapes, terrace paving.",
        slipRating: "R11 Anti-Skid",
        heatResistance: "Poolside Certified",
      },
    ],
    specifications: {
      thicknessesMetric: ["15mm", "18mm", "20mm", "25mm"],
      thicknessesImperial: ["5/8 in", "3/4 in", "13/16 in", "1 in"],
      standardSizesMetric: ["300 x 300 mm", "600 x 300 mm", "600 x 600 mm", "Pavers", "Steps", "Custom Sizes"],
      standardSizesImperial: ["1x1 ft", "2x1 ft", "2x2 ft", "Pavers", "Steps", "Custom Sizes"],
      densityMetric: "2,680 kg/m³",
      densityImperial: "167.3 lbs/ft³",
      waterAbsorption: "< 0.40% (Extreme Density)",
      compressiveStrengthMetric: "145 MPa",
      compressiveStrengthImperial: "21,030 psi",
      exportStandards: "ISO 9001:2015 · Full Container Load (FCL) Fumigated Crating",
    },
    applications: [
      {
        title: "Outdoor Flooring, Patios & Verandas",
        category: "Exterior Paving",
        desc: "Engineered for high durability across residential and commercial patios.",
      },
      {
        title: "Driveways & Parking Areas (withstands vehicle weight)",
        category: "Vehicular Paving",
        desc: "High compressive strength supporting heavy passenger vehicles without cracking.",
      },
      {
        title: "Garden Pathways & Stepping Stones",
  ...
  "pavan-stones-world": {
    ...
    geologyStory: {
      ...
      description:
        "Specializing in high-pressure metamorphic quartzites and pristine calcitic marbles, Pavan Stones World bridges sovereign quarry belts with visionary architecture. From translucent crystalline quartz ribbons to historical 99% pure Makrana calcite, each specimen is selected for supreme hardness, chemical immunity, and mesmerizing natural beauty.",
      points: [
        "Metamorphic quartz formations boasting 7.0+ Mohs hardness, outperforming standard granite.",
        "Natural crystalline light-translucency engineered for illuminated backlit feature installations.",
        "100% natural mineral provenance — zero artificial resins, chemical bleaches, or dye infill.",
        "Precision robotic 5-axis waterjet cutting and laser-guided digital bookmatch layout alignment.",
      ],
    },
    finishesGuide: [
      {
      ...
      {
        name: "Honed Matte",
        texture: "Smooth satin finish bringing out subtle natural grain without glare",
        reflectivity: "Ultra Smooth Matte",
        slipRating: "R11 (Slip-Resistant)",
        bestFor: "Luxury Flooring, Wall Cladding & Spa Terraces",
        icon: "◎",
      },
      {
        name: "Artisanal Bas-Relief",
        texture: "Intricately hand-sculpted and 5-axis CNC contoured dimensional texture",
        reflectivity: "Tactile Dimensional Relief",
        slipRating: "3D Art Surface",
        bestFor: "Civic Atriums, Devotional Murals & Estate Entrances",
        icon: "⬡",
      },
    ],
    products: [
    ...
    specifications: {
      ...
      standardSizesMetric: [
        "Jumbo Gangsaw Slabs (3200x1900 mm)",
        "Bookmatched Pairs",
        "1200 x 600 mm",
        "600 x 600 mm",
        "Custom CNC Cuts"
    ...
    applications: [
      ...
      {
        title: "Palatial Living Pavilions & Marble Floors",
        category: "Residential Magnificence",
        desc: "Pure white Makrana marble reflecting natural light across grand interior spaces.",
      },
      {
        title: "Monumental Architectural Murals & Inlays",
        category: "Bespoke Artistry",
        desc: "Precision CNC carved stone murals and multi-marble inlays for prestigious landmarks.",
      },
      {
        title: "Spa Elevations & Master Bath Suites",
        category: "Wellness & Spa",
        desc: "Impervious natural stone creating organic sanctuary environments.",
      },
    ],
    packaging: {
      ...
      avgWeightPerSqm20mm: 56, // 56 kg per sqm for 20mm
    },
  },
};

export default function CompanyDedicatedPage() {
  const company = COMPANIES_DATABASE["pavan-stones-world"];
  ...
  return (
    <main className="relative bg-[#f2f2f2] min-h-screen text-[#140d0a] selection:bg-[#ff5500] selection:text-white">
      ...
      <section className="sticky top-0 z-0 w-full aspect-video md:aspect-auto md:h-screen min-h-[480px] md:min-h-[600px] flex items-center justify-center overflow-hidden bg-[#0c1c22] pt-[72px]">
        ...
        >
          {/* Stunning Natural Background - Exotic Quartzite & Marble Architecture */}
          <img
            src="https://images.unsplash.com/photo-1618221195710-dd6b41faaea6?auto=format&fit=crop&w=2000&q=80"
            alt="PAVAN STONES WORLD Background"
        ...
        <div className="relative z-10 text-center px-4">
          ...
          >
            <motion.text
              ...
              className="font-display font-bold text-[60px] sm:text-[80px] md:text-[98px] tracking-[0.16em]"
      ...
      <div className="relative z-10 bg-white shadow-[0_-30px_70px_-15px_rgba(0,0,0,0.35)]">
        ...
        <section id="about" className="py-16 md:py-24 px-6 md:px-14 lg:px-20 bg-white border-b border-[#747474]/15">
          <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            ...
            {/* Left: Image */}
            <div className="relative aspect-[4/3] w-full overflow-hidden bg-[#112a32] rounded-none shadow-lg border border-[#747474]/20">
              <img
                src="https://images.unsplash.com/photo-1600585154526-990dced4db0d?auto=format&fit=crop&w=1600&q=85"
                alt="Pavan Stones World Architectural Curation"
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4 text-[15px] sm:text-[16px] leading-[1.8] text-[#3a3a3a] font-light">
                ...
                <p>
                  Uniting sovereign quarry sources with state-of-the-art 5-axis robotic bridge saws and master hand-sculptors, we process raw monolithic boulders into crystalline architectural masterpieces. Every slab undergoes strict spectroscopic mineral density verification and laser-calibrated bookmatching.
                </p>

                <p>
                  With full turnkey international logistics — including custom edge detailing, digital slab dry-lays, high-density EPE foam encasement, and ocean freight forwarding — we provide world-class architects with flawless material continuity and dependable supply chains.
                </p>
              </div>

              <div className="pt-4 border-t border-[#747474]/15 grid grid-cols-3 gap-4">
                <div>
                  <span className="block text-[11px] font-mono uppercase tracking-wider text-[#747474]">Core Speciality</span>
                  <span className="text-xs sm:text-sm font-medium text-[#241919]">Exotics, Quartzite &amp; Marble</span>
                </div>
                <div>
                  <span className="block text-[11px] font-mono uppercase tracking-wider text-[#747474]">Global Footprint</span>
                  <span className="text-xs sm:text-sm font-medium text-[#241919]">50+ Sovereign Nations</span>
                </div>
                <div>
                  <span className="block text-[11px] font-mono uppercase tracking-wider text-[#747474]">Hardness Standard</span>
                  <span className="text-xs sm:text-sm font-medium text-[#241919]">Mohs 7.0+ Toughness</span>
                </div>
              </div>
            </div>
        ...
        {/* ── OUR HERITAGE & CRAFTSMANSHIP MONOGRAPH ── */}
        <CompanyEditorialShowcase data={PAVAN_STONES_WORLD_EDITORIAL_DATA} />

      {/* ── FULL MATERIAL VARIETIES CATALOGUE ── */}
      <RangeCarousel products={company.products} subtitle="Exotic Stones & Artifacts" />
            ...
            {Object.values(COMPANIES_DATABASE)
              ...
              .map((other) => (
                <Link
                  ...
                  className="bg-white border border-[#747474]/20 hover:border-[#722424] p-6 sm:p-8 flex flex-col justify-between group transition-all shadow-xs hover:shadow-lg"
                >
                  <div>
                    ...
                    <h4 className="font-display text-2xl font-light text-[#241919] group-hover:text-[#722424] transition-colors mb-1">
                      {other.name}
                    </h4>
                  ...
                  <span className="inline-flex items-center gap-2 text-[10px] font-mono uppercase tracking-[0.16em] font-semibold text-[#241919] group-hover:text-[#722424] transition-colors mt-6 pt-4 border-t border-[#747474]/15">
